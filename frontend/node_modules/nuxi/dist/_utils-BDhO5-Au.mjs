...
import { c as confirm, n as logger, v as isCancel } from "./logger-Ctyg44_g.mjs";
...
import { c as ye, n as Mn, t as Mi } from "./node-BW6Kf3mt.mjs";
...
function isPnpmWorkspace(packageManager, cwd) {
	return packageManager?.name === "pnpm" && existsSync(resolve$1(cwd, "pnpm-workspace.yaml"));
}
...
//#endregion
export { getProjectDependencies as a, $fetch as c, forwardCommandArgs as i, ensureNuxtDependency as n, getRegistryFromContent as o, fetchModules as r, isPnpmWorkspace as s, checkNuxtCompatibility as t };
