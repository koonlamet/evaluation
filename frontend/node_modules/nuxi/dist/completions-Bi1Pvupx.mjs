import { t as defineCommand } from "./dist-DFQuaDR6.mjs";
import { templates } from "./templates-BuoLXAmw.mjs";
import assert from "node:assert";
//#region ../../node_modules/.pnpm/@bomb.sh+tab@0.0.17_cac@6.7.14_citty@0.2.2/node_modules/@bomb.sh/tab/dist/index.mjs
const a = {
...
var o = class {
	...
	handlePositionalCompletion(e, t) {
		let n = this.stripOptions(t), r = e.value.split(` `).length, i = Math.max(0, n.length - r), a = Array.from(e.arguments.entries());
		if (a.length > 0) {
			let t;
			if (i < a.length) {
				let [e, n] = a[i];
	...
	parse(e) {
		...
		this.shouldCompleteFlags(a, n) ? this.handleFlagCompletion(i, r, n, a) : (this.shouldCompleteCommands(n) && this.handleCommandCompletion(r, n), i && i.arguments.size > 0 && this.handlePositionalCompletion(i, r)), this.complete(n);
	}
	setup(a, o, s) {
...
const u$1 = new l$1();
//#endregion
//#region ../../node_modules/.pnpm/@bomb.sh+tab@0.0.17_cac@6.7.14_citty@0.2.2/node_modules/@bomb.sh/tab/dist/powershell-CHePOaos.mjs
function t(t, n) {
	return `#compdef ${t}
compdef _${t} ${t}
...
//#endregion
//#region ../../node_modules/.pnpm/@bomb.sh+tab@0.0.17_cac@6.7.14_citty@0.2.2/node_modules/@bomb.sh/tab/dist/shared-DAgv99GA.mjs
function e(e = `cli`) {
...
//#endregion
//#region ../../node_modules/.pnpm/@bomb.sh+tab@0.0.17_cac@6.7.14_citty@0.2.2/node_modules/@bomb.sh/tab/dist/citty.mjs
async function s(e) {
	let t = [], n = [];
