...
import { i as upperFirst, n as kebabCase } from "./dist-BQ8ewVyW2.mjs";
import { t as formatInfoBox } from "./formatting-R-raNdji.mjs";
import { r as fetchModules, t as checkNuxtCompatibility } from "./_utils-BDhO5-Au.mjs";
...
async function findModuleByKeywords(query, nuxtVersion) {
	const results = new entry_default((await fetchModules()).filter((m) => checkNuxtCompatibility(m, nuxtVersion)), {
		threshold: .1,
		keys: [
			{
				name: "name",
