...
import { r as version } from "./package-BmvvItkB.mjs";
import { a as legacyRootDirArgs, t as cwdArgs } from "./_shared-D6pJgr6t.mjs";
import { n as logger, o as box } from "./logger-Ctyg44_g.mjs";
...
import { t as getBuilder } from "./banner-DUqVZwHL.mjs";
import { writeText } from "./dist-DoeyVB03.mjs";
import { i as detectPackageManager } from "./dist-zVHldZwh.mjs";
import { t as formatInfoBox } from "./formatting-R-raNdji.mjs";
import { t as getPackageManagerVersion } from "./packageManagers-BKHLYY1e.mjs";
...
async function getNuxtConfig(rootDir) {
	try {
		const { createJiti } = await import("./jiti-sm19nk94.mjs").then((n) => n.t);
