...
import { t as runCommand } from "./run-P2vlcYgl.mjs";
import { a as autocompleteMultiselect, c as confirm, m as spinner, n as logger, p as select, s as cancel, v as isCancel } from "./logger-Ctyg44_g.mjs";
...
import { t as require_semver } from "./semver-D6aqw23T.mjs";
import { t as getNuxtVersion } from "./versions-CnK0epca.mjs";
import { i as detectPackageManager, t as addDependency } from "./dist-zVHldZwh.mjs";
import { a as getProjectDependencies, c as $fetch, i as forwardCommandArgs, n as ensureNuxtDependency, o as getRegistryFromContent, r as fetchModules, s as isPnpmWorkspace, t as checkNuxtCompatibility } from "./_utils-BDhO5-Au.mjs";
import { t as updateConfig } from "./update-BBxxG42c.mjs";
import { t as prepare_default } from "./prepare-BB26623y.mjs";
...
var add_default = defineCommand({
	...
	async setup(ctx) {
		...
		if (!ctx.args.skipInstall) await runCommand(prepare_default, forwardCommandArgs(ctx.args));
	}
});
