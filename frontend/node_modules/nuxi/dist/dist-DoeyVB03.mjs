...
//#region ../../node_modules/.pnpm/tinyclip@0.1.14/node_modules/tinyclip/dist/index.js
const TIMEOUT = 3e3;
...
const WINDOWS_WRITE_COMMAND = ["powershell", [
	"-NoProfile",
	"-Command",
...
async function getWriteCommand() {
	switch (process.platform) {
		...
		case "win32": return WINDOWS_WRITE_COMMAND;
		case "linux":
		case "freebsd":
		case "openbsd":
			if (process.env.WSL_DISTRO_NAME) return WINDOWS_WRITE_COMMAND;
