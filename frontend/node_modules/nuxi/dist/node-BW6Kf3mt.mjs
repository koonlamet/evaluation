...
const mr = Symbol.toStringTag, wi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ks = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Js = n((i, o) => {
...
}, "isSameProtocol"), el = promisify(r.pipeline), H = Symbol("Body internals"), Nn = class Nn {
	constructor(o, { size: a = 0 } = {}) {
		let f = null;
		o === null ? o = null : wi(o) ? o = Buffer$1.from(o.toString()) : yr(o) || Buffer$1.isBuffer(o) || (types.isAnyArrayBuffer(o) ? o = Buffer$1.from(o) : ArrayBuffer.isView(o) ? o = Buffer$1.from(o.buffer, o.byteOffset, o.byteLength) : o instanceof r || (o instanceof br ? (o = Zs(o), f = o.type.split("=")[1]) : o = Buffer$1.from(String(o))));
		let l = o;
		Buffer$1.isBuffer(o) ? l = r.Readable.from(o) : yr(o) && (l = r.Readable.from(o.stream())), this[H] = {
			body: o,
			stream: l,
			boundary: f,
			disturbed: !1,
			error: null
		}, this.size = a, o instanceof r && o.on("error", (p) => {
	...
	async formData() {
		...
		const { toFormData: a } = await import("./multipart-parser-Cx7Oc8EN.mjs");
...
async function zn(i) {
	...
	if (!(o instanceof r)) return Buffer$1.alloc(0);
	const a = [];
	let f = 0;
	try {
...
const In = n((i, o) => {
	...
	return l instanceof r && typeof l.getBoundary != "function" && (a = new PassThrough({ highWaterMark: o }), f = new PassThrough({ highWaterMark: o }), l.pipe(a), l.pipe(f), i[H].stream = a, l = f), l;
}, "clone"), tl = deprecate((i) => i.getBoundary(), "form-data doesn't follow the spec and requires special treatment. Use alternative package", "https://github.com/node-fetch/node-fetch/issues/1167"), Ri = n((i, o) => i === null ? null : typeof i == "string" ? "text/plain;charset=UTF-8" : wi(i) ? "application/x-www-form-urlencoded;charset=UTF-8" : yr(i) ? i.type || null : Buffer$1.isBuffer(i) || types.isAnyArrayBuffer(i) || ArrayBuffer.isView(i) ? null : i instanceof br ? `multipart/form-data; boundary=${o[H].boundary}` : i && typeof i.getBoundary == "function" ? `multipart/form-data;boundary=${tl(i)}` : i instanceof r ? null : "text/plain;charset=UTF-8", "extractContentType"), rl = n((i) => {
	const { body: o } = i[H];
...
async function Ai(i, o) {
	return new Promise((a, f) => {
		...
		const A = n(() => {
			...
			f(g), l.body && l.body instanceof r.Readable && l.body.destroy(g), !(!w || !w.body) && w.body.emit("error", g);
		}, "abort");
		if (v && v.aborted) {
			A();
			return;
			...
			if (jn(g.statusCode)) {
				...
				switch (l.redirect) {
					...
					case "follow": {
						...
						if (g.statusCode !== 303 && l.body && o.body instanceof r.Readable) {
