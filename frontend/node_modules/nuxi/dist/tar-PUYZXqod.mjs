import { t as __exportAll } from "./rolldown-runtime-CGrdTa9n.mjs";
...
import ae from "zlib";
//#region ../../node_modules/.pnpm/giget@3.3.0/node_modules/giget/dist/_chunks/libs/tar.mjs
var ce = __exportAll({
	Header: () => I,
	Pack: () => ii,
	PackJob: () => Lr,
...
var Ir = class {
	...
	[Yr](e) {
		...
		this[zr](e, fs$1[t](e.absolute));
	}
	[Xr](e) {
		this[Zr](e, fs$1.readdirSync(e.absolute));
	}
	[Qr](e) {
		let t = e.entry, n = this.zip;
...
}), di = (process.env.__FAKE_PLATFORM__ || process.platform) === `win32`, { O_CREAT: fi, O_NOFOLLOW: pi, O_TRUNC: mi, O_WRONLY: hi } = fs$1.constants, gi = Number(process.env.__FAKE_FS_O_FILENAME__) || fs$1.constants.UV_FS_O_FILEMAP || 0, _i = di && !!gi, vi = 512 * 1024, yi = gi | mi | fi | hi, bi = !di && typeof pi == `number` ? pi | mi | fi | hi : null, xi = bi === null ? _i ? (e) => e < vi ? yi : `w` : () => `w` : () => bi, Si = (e, n, r) => {
	try {
	...
	t.isDirectory() ? Ti(path.resolve(e, t.name), n, r, (o) => {
		if (o) return a(o);
		Ci(path.resolve(e, t.name), n, r, a);
	}) : Ci(path.resolve(e, t.name), n, r, a);
}, Ti = (e, n, r, i) => {
	...
	t.isDirectory() && Di(path.resolve(e, t.name), n, r), Si(path.resolve(e, t.name), n, r);
}, Di = (e, n, r) => {
	let i;
	try {
	...
	let o = r.umask ?? 18, s = r.mode | 448, c = (s & o) !== 0, l = r.uid, u = r.gid, d = typeof l == `number` && typeof u == `number` && (l !== r.processUid || u !== r.processGid), f = r.preserve, ee = r.unlink, p = z(r.cwd), m = (n, r) => {
		n ? a(n) : r && d ? Ti(r, l, u, (e) => m(e)) : c ? fs.chmod(e, s, a) : a();
	};
	...
	Mi(p, z(path.relative(p, e)).split(`/`), s, ee, p, void 0, m);
}, Mi = (e, n, r, a, o, s, c) => {
	if (n.length === 0) return c(null, s);
	let l = n.shift(), u = z(path.resolve(e + `/` + l));
	fs.mkdir(u, r, Ni(u, n, r, a, o, s, c));
}, Ni = (e, n, r, i, a, o, s) => (c) => {
	c ? fs.lstat(e, (l, u) => {
	...
	let r = n.umask ?? 18, a = n.mode | 448, o = (a & r) !== 0, s = n.uid, c = n.gid, l = typeof s == `number` && typeof c == `number` && (s !== n.processUid || c !== n.processGid), u = n.preserve, d = n.unlink, f = z(n.cwd), ee = (n) => {
		n && l && Di(n, s, c), o && fs.chmodSync(e, a);
	};
	...
	#s = /* @__PURE__ */ new Set();
	reserve(e, t) {
		e = Bi ? [`win32 parallelization disabled`] : e.map((e) => Yn(join(zi(e))));
	...
	[Yi](e, n) {
		...
		this[ra](String(e.absolute), r, (r) => {
			...
			e.mtime && !this.noMtime && (i++, fs.utimes(String(e.absolute), e.atime || /* @__PURE__ */ new Date(), e.mtime, a)), this[ua](e) && (i++, fs.chown(String(e.absolute), Number(this[da](e)), Number(this[fa](e)), a)), a();
		});
	}
	[ea](e) {
	...
	[$i](e, n, r, a, o) {
		...
		fs.lstat(c, (t, n) => {
			if (t) return a();
			if (n?.isSymbolicLink()) return o(new ki(c, path.resolve(c, r.join(`/`))));
			this[$i](e, c, r, a, o);
		});
	}
	[aa]() {
	...
	[Gi](e) {
		...
		let [n, r] = ba(() => fs.lstatSync(String(e.absolute)));
		...
		if (r.isDirectory()) {
			...
			let [n] = ba(() => fs.rmdirSync(String(e.absolute)));
			this[Q](n, e);
		}
	...
	[Ji](e, n) {
		...
		try {
			a = fs.openSync(String(e.absolute), xi(e.size), r);
		} catch (e) {
			return i(e);
		}
	...
	[Yi](e, n) {
		...
		if (this[ua](e)) try {
			fs.chownSync(String(e.absolute), Number(this[da](e)), Number(this[fa](e)));
		} catch {}
		n(), e.resume();
	}
	[ra](e, t) {
	...
	[$i](e, n, r, a, o) {
		...
		for (let e of r) {
			s = path.resolve(s, e);
			let [c, l] = ba(() => fs.lstatSync(s));
			if (c) return a();
			if (l.isSymbolicLink()) return o(new ki(s, path.resolve(n, r.join(`/`))));
		}
		a();
	}
	[Xi](e, n, r, i) {
	...
	let n = new xa(e), r = e.file, i = fs.statSync(r);
	new ft(r, {
